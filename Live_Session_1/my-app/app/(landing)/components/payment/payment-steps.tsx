...
const PaymentSteps = () => {
    ...
    const handleConfirmPayment = async () => {
        if (!file) {
            alert("Please upload yourn payment receipt");
            return;
        }
    ...
    return <CardWithHeader title="Payment Steps">
        <div className="p-5">
            <ol className="list-decimal text-xs pl-2 flex flex-col gap-4 mb-5">
                <li>
                    Transfer the total amount of <b>{PriceFormatter(totalPrice)}</b> to your preferred bank 
                ...
                <li>
                    Upload the payment receipt/screenshot using the <b>'Upload 
                    Receipt & Confirm'</b> button below to validate your transaction.
                </li>     
            </ol>
        ...
        <div className="border-t border-gray-200 p-4">
            ...
            >
                <FiCheckCircle size={22} /> Upload Receipt & Confirm
            </Button>
        </div>  
    </CardWithHeader>
}
